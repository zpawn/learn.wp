...
foreach ($blocks as $block) {
    ...
    $block_classes[$block] .= ($this['config']->get("block.{$block}.block-padding-large")) ? ' tm-block-padding-large' : '';
    $block_classes[$block] .= ($this['config']->get("block.{$block}.block-divider")) ? ' tm-block-divider' : '';
...
$body_config = array();
$body_config['fixednav']  = (int) $config->get('fixed_navigation', 0);
$body_config['centerlogo']= (int) $config->get('centered_logo', 0);
